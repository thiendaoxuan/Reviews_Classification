...
from dataHelper_both import load_data,ENTITY, tmp_sequence_length, VOCAB, VOCAB_INV, BOTH
...
for aspect in BOTH:
    ...
    entityFolder = 'TrainedModel/attribute/' + entity
    ...
    print ("-------------------------")
    print (aspect)
    print "Training information. " + "Postitive : " + str(y.tolist().count(1)) + " . Negative : " + str(
        y.tolist().count(0))
    print "Testing information. " + "Postitive : " + str(y_test.tolist().count(1)) + " . Negative : " + str(
    ...
    directory = 'TrainedModel/attribute/' +entity
